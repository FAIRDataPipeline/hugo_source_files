...
2. Choose an appropriate [filename]({{% ref "/docs/API/R/1_generate_dp/_index.md#filenames-and-version-numbers" %}}):

   ``` R
   filename <- "0.1.0.toml"
   ```

3. Choose an appropriate [data product name]({{% ref "/docs/API/R/1_generate_dp/_index.md#data-product-names" %}}):

   ``` R
   data_product_name <- "human/infection/SARS-CoV-2/asymptomatic-period"
   ```

4. List a single component (see [TOML components]({{% ref "/docs/API/R/1_generate_dp/_index.md#toml-components" %}})):
